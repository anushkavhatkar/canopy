...
// #region UNSUCCESSFUL MOUSE FOLLOWS CURSOR
...
// function nativeTextDisplay() { 
//   hoverText.innerHTML = " ";
//   hoverText.innerHTML = "Native";
// }

// function nonNativeTextDisplay() {
//   hoverText.innerHTML = "";
//   hoverText.innerHTML = "Non-Native";
// }
// #endregion
...
// #region UNSUCCESSFUL FOR EACH SQUARE DIV LOOP

squareDivs.forEach(squareDiv => {
  let computedStyle = window.getComputedStyle(squareDiv);
  let backgroundColor = computedStyle.backgroundColor;
  
  squareDiv.addEventListener("mouseover", function (){
      if (nativeColorsArray.includes(squareDiv.style.backgroundColor)) {
    hoverText.innerHTML = " ";
    hoverText.innerHTML = "Native";
  } else if (nonNativeColorsArray.includes(squareDiv.style.backgroundColor)) {
    hoverText.innerHTML = "";
    hoverText.innerHTML = "Non-Native";
  }
// #endregion 
